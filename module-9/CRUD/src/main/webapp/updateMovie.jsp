...
<%
    String movieIdParam = request.getParameter("movieId"); // Retrieving the movieId from the request parameters
    if (movieIdParam == null || movieIdParam.isEmpty()) {
        response.sendRedirect("displayAllMovies.jsp"); // Redirect to a page that lists all movies
    } else {
        int movieId = Integer.parseInt(movieIdParam); // Parsing the movieId to an integer
